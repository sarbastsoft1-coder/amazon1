      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                Expanded(child: TextField(controller: _coupon, decoration: const InputDecoration(hintText: 'Enter coupon code'))),
      ...
      bottomSheet: Container(
        ...
        child: SafeArea(
          child: ElevatedButton(
            ...
            child: _placing ? const CircularProgressIndicator() : const Text('Place Order'),
          ),
        ),
      ),
    );
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Text(value, style: isTotal ? const TextStyle(fontWeight: FontWeight.bold, fontSize: 18, color: AppTheme.primaryColor) : null),
        ],
      ),
    );
  }
